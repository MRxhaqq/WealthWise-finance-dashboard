        ...
        <div className="px-2">
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <button
              onClick={() =>
                window.open(
                  "https://github.com/MRxhaqq/WealthWise-finance-dashboard",
                  "_blank",
                  "noopener,noreferrer",
                )
              }
              className="flex items-center gap-1.5 text-xs text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors duration-150 cursor-pointer bg-transparent border-none p-0"
            >
              <svg
                width="13"
                height="13"
            ...
            <span className="text-slate-300 dark:text-dark-500 text-xs">·</span>
